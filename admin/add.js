...
var outfname = document.ad.m_name;
var outimage = document.ad.p_image;
var outtwo = document.ad.two_w_price;
var outthree = document.ad.auto_w_price;
var outfour = document.ad.car_w_price;
var outheavy = document.ad.bus_w_price;
...
function threecheck() {
        if (outthree.value.match(/^(\d*([.,](?=\d{3}))?\d+)+((?!\2)[.,]\d\d)?$/)) {
                ...
                document.ad.auto_w_price.focus();
        }
}
