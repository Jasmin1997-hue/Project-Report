            ...
            <tbody>
                ...
                ?>
                        ...
                        <td>
                            ...
                            include "db.php";
                            $id = $row['slot_id'];
                            $sql2 = "select * from slots where slot_id = '$id'";
                        ...
                        <td>
                            ...
                            if ($row['status'] == "1")
                                echo
                                "<a href=sloteditdeactivate.php?id=" . $row['slot_id'] . " class=' btn btn-primary ' >Reject</a>";
                            else
                                echo
                                "<a href=sloteditactivate.php?id=" . $row['slot_id'] . " class='btn btn-success'>Approve</a>";
                            ?>
                            </tr>
                            <tr> </tr>
                        </td>
