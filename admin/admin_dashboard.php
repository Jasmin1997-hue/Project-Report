                    ...
                    <div class="card">
                        <div class="card-header p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                <p class="text-sm mb-0 text-capitalize"><a href="admin_dashboard.php"> THEATERS </a></p>
                        ...
                        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                            <div class="card">
                                <div class="card-header p-3 pt-2">
                                    ...
                                    <div class="text-end pt-1">
                                        <p class="text-sm mb-0 text-capitalize"><a href="slot.php">THEATER DETAILS </a></p>
                                ...
                                <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                                    <div class="card">
                                        <div class="card-header p-3 pt-2">
                                            ...
                                            <div class="text-end pt-1">
                                                <p class="text-sm mb-0 text-capitalize"><a href="slot.php">SLOT</a></p>
                                        ...
                                        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                                            <div class="card">
                                                <div class="card-header p-3 pt-2">
                                                    ...
                                                    <div class="text-end pt-1">
                                                        <p class="text-sm mb-0 text-capitalize"><a href="userS.php">USER </a></p>
    ...
    <!-- <script>
        ...
        urlMenu.onChange = function() {
            ...
            if (useroption.value != "nothing") {
                ...
                alert("called");
                window.open(useroption.value, " ADD EDIT", "");
            }
        }
    </script> -->
    <!-- Github buttons -->
