                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="thedit.php" method="post">
                                        ...
                                        <td>
                                            ...
                                            include "db.php";
                                            $id = $row['vechile_id'];
                                            $sql2 = "select * from theater where vechile_id = '$id'";
                                        ...
                                        <td>
                                            ...
                                            if ($row['status'] == "1")
                                                echo
                                                "<a href=detailsdeactivate.php?id=" . $row['vechile_id'] . " class='btn btn-primary ' >Deactivate</a>";
                                            else
                                                echo
                                                "<a href=detailsactivate.php?id=" . $row['vechile_id'] . " class='btn btn-success'>Activate</a>";
                                            ?>
                                    </tr>
                                    <tr></tr>
                                    </td>
